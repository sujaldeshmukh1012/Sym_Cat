...
GEMINI_API_KEY_LIVE  = os.getenv(GEMINI_API_KEY)
INSPEX_BASE_URL_LIVE = os.getenv(INSPEX_BASE_URL)
API_BASE_URL    = "http://localhost:8000"   # local FastAPI server
TEST_IMAGE_PATH = "/Users/manav/Desktop/dev/projects/Sym_Cat/cat_core/data/test/BrokenRimBolt2.jpg"
