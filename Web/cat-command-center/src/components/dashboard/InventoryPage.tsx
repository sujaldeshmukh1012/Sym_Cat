...
export default function InventoryPage() {
  ...
  const filtered = items.filter(item => {
    ...
    if (hasExactFleetMatch) return String(item.fleet_serial ?? '') === normalizedSearch;
    return (
  ...
  function getStockState(value: any) {
      ...
      <div className="card">
        <div className="card-header">
          <div className="search-bar">
            ...
            <input placeholder="Search by fleet serial, part number, part name, or component tag…" value={search} onChange={e => setSearch(e.target.value)} />
          </div>
